...
/**
 * Slow drifting violet and lilac blobs behind a section, fading out toward the bottom so
...
export function FluidGradient({ className }: { className?: string }) {
  return (
    <div aria-hidden className={cn("pointer-events-none absolute inset-x-0 top-0 -z-10 overflow-hidden", className)}
      ...
      <div className="absolute -top-1/4 -right-1/4 size-[58vmax] rounded-full bg-[radial-gradient(circle_at_center,var(--highlight),transparent_62%)] opacity-40 blur-3xl animate-drift-slow" />
